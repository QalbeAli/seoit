    ...
    <section className="flex flex-col items-center justify-center pt-4 bg-gray-50">
      ...
      <div className="flex flex-wrap justify-center gap-6 mx-3">
        ...
        <div className="p-8 bg-white rounded-lg shadow-lg flex flex-col w-full sm:w-80 md:w-64 lg:w-80">
          <div className="flex space-x-4">
            ...
            <div>
              ...
              <div className="mt-2 text-4xl flex font-bold text-gray-900">
                ${isMonthly ? "29" : "261"}
          ...
          <ul className="mt-4 space-y-2.5 text-gray-600">
            <li className="flex font-semibold text-sm text-black">
          ...
          <button className="px-6 py-3 mt-auto  w-full text-white bg-blue-500 rounded-full">
            Choose Starter
          </button>
        </div>
        ...
        <div className="p-8 bg-gray-800 rounded-lg shadow-lg flex flex-col w-full sm:w-80 md:w-64 lg:w-80 text-white">
          ...
          <button className="px-6 py-3 mt-8 w-full text-white bg-orange-600 rounded-full">
            Choose Professional
          </button>
        </div>
