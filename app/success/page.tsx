  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-green-100">
      <div className="text-center p-8 bg-white shadow-md rounded-lg max-w-lg">
        <svg
          className="w-16 h-16 mx-auto mb-4 text-green-500 animate-pulse"
        ...
        <p className="text-gray-700 mb-8">Thank you for your purchase. Your payment has been processed successfully.</p>
        <button
          onClick={() => router.push('/')}
